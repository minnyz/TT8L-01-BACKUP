...
def load_level(level_number):
    if level_number == 1:
        ...
        background_image = pygame.transform.scale(background_image, (1720, 720))
        portal = Portal(1600 - 100, 720 - 150)  # Place portal at the end of the level
    elif level_number == 2:
        background_image = pygame.image.load("assets/background2.png")
        background_image = pygame.transform.scale(background_image, (1600, 720))
        portal = Portal(1600 - 100, 720 - 150)
    elif level_number == 3:
        background_image = pygame.image.load("assets/background3.png")
        background_image = pygame.transform.scale(background_image, (1600, 720))
        portal = Portal(1600 - 100, 720 - 150)
    else: 
        import menu
...
def main():
    ...
    WORLD_WIDTH, WORLD_HEIGHT = 1600, 720
